...
sqlite-utils insert ./data/posts.db following --csv ./data/followers.csv --detect-types --pk=id
sqlite-utils create-index ./data/posts.db following follower_username following_username --unique